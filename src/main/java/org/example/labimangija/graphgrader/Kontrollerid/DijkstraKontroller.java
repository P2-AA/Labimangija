...
import org.example.labimangija.graphgrader.Util.TippudeKuhi;
...
public class DijkstraKontroller {
    ...
    public void laeGraaf(MouseEvent ignored) throws IOException {
        failitee = GraafiValija.valiFailVoiGenereeri("graafid/suunatud_kaalutud", GraafiGenereerija.Tyyp.SUUNATUD_KAALUTUD);
