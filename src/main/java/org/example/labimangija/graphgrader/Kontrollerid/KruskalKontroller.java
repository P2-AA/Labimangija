...
import org.example.labimangija.graphgrader.Util.KaarteKuhi;
...
public class KruskalKontroller {
    ...
    public void laeGraaf(MouseEvent ignored) throws IOException {
        failitee = GraafiValija.valiFailVoiGenereeri("graafid/suunatud_kaalutud", GraafiGenereerija.Tyyp.SIDUS_KAALUTUD);
