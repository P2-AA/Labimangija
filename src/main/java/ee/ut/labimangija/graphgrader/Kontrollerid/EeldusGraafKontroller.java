...
public class EeldusGraafKontroller {
    ...
    private void taastaYlesanne() {
        topoloogilineJarjestus.clear();
        sisestatud.clear();
        varaseimLoppOlemas = null;
        hilisemAlgusOlemas = null;
        koguAeg = 0;
        samm = 1;
        vead.clear();
        sammud.clear();
    ...
    public void naitaGraafi() {
        ...
        for (int i = 0; i < g.tipud.size(); i++) {
            ...
            tippEkraanil.setStroke(Color.BLACK);
    ...
    public Group lisaTipuKasitleja(TippGraafil tipp) {
        ...
        tipp.addEventHandler(MouseEvent.MOUSE_DRAGGED, e -> {
            ...
            tipp.tipp.y = (int) Math.round(e.getY());
            paigutaTipuTekstid(tipp, tekst1, tekst2, tekst3, tekst4);
            uuenda();
        });
    ...
    private void paigutaTipuTekstid(TippGraafil tipp, Text tekst1, Text tekst2, Text tekst3, Text tekst4) {
        double x = tipp.getCenterX();
        double y = tipp.getCenterY();
        tekst1.setX(x - 13);
        tekst1.setY(y - 7);
        tekst2.setX(x + 7);
        tekst2.setY(y - 7);
