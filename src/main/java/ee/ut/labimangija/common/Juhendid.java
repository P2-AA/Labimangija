...
public final class Juhendid {
    ...
    public static String graaf(String key) {
        return switch (key) {
            ...
            case "eeldus" ->
                "Graafi eeldusanalüüs\n\nTuleb leida viis, kuidas tipud paraleelselt töötades oleksid kõige optimaalsema algus ja lõpuajaga\n\nSisesta topoloogiline järjestus (tipu tähised komadega eraldatud), seejärel märgi igale tipule varaseim lõpuaeg, siis märgi kogu projekti (graafi) varaseim lõpuaeg, seejärel märgi igale tipule hiliseim algusaeg ja lõpuks sisesta kriitilised tipud. Aktiivse tipu sees olevaid andmeid on võimalik muuta kui tipule klikkata. Tipu alumine vasak väli tähistab varaseimat lõppu ja alumine parem väli tähistab hiliseimat algust";
    ...
    public static String paisktabel(String key) {
        return switch (key) {
            case "lisamine" ->
                "Lisamine\n\nKasuta \"Alusta\" nuppu, et laadida uus ülesanne. Seejärel täida väljad i = alammassiivi indeks, r = paisktabeli rida ja vajadusel k = koht ning kasuta \"Sisesta\" nuppu. \"Võta tagasi\" tühistab viimase sammu ja \"Lõpeta\" hindab lahenduse.";
            case "eemaldamine" ->
                "Eemaldamine\n\nKasuta \"Alusta\" nuppu, et laadida uus ülesanne. Seejärel täida väljad i = alammassiivi indeks, r = paisktabeli rida ja vajadusel k = koht ning kasuta \"Eemalda\" nuppu. \"Võta tagasi\" tühistab viimase sammu ja \"Lõpeta\" hindab lahenduse.";
            case "kimp" ->
                "Kimbumeetod\n\nKasuta \"Alusta\" nuppu, et laadida uus ülesanne. Esmalt sisesta algseadistus kujul a = minimaalne element, b = maksimaalne element ja m = kimpude arv, seejärel kasuta välju i = alammassiivi indeks, r = paisktabeli rida ja vajadusel k = koht vastavate sammude tegemiseks. \"Võta tagasi\" tühistab viimase sammu ja \"Lõpeta\" hindab lahenduse.";
            case "positsioon" ->
                "Positsioonimeetod\n\nKasuta \"Alusta\" nuppu, et laadida uus ülesanne. Esmalt sisesta paisktabeli pikkus, seejärel kasuta välju i = alammassiivi indeks, r = paisktabeli rida ja vajadusel k = koht vastavate sammude tegemiseks. \"Võta tagasi\" tühistab viimase sammu ja \"Lõpeta\" hindab lahenduse.";
            default -> "";
        };
    }
}
