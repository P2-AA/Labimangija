...
public final class Juhendid {
    ...
    public static String graaf(String key) {
        return switch (key) {
            ...
            case "kruskal" ->
                "Minimaalse kaaluga toespuu leidmine (Kruskal)\n\nKasutatav andmestruktuur: kuhi\n\nKõik tipud on märgitud töödelduks. Lisa toesesse kuuluvad kaared. Hakka eelistusjärjekorrast kaari võtma ning iga kaare kohta otsusta, kas ta kuulub toesesse või mitte.";
    ...
    public static String kahendpuu(String key) {
        return switch (key) {
            case "jarjend_bst" ->
                "Kasutusjuhend:\n- Kontrolli lisamist: kontrollib, kas tipp on lisatud korrektselt ja võtab järjendist lisamiseks uue tipu.\n- Eelmine puu olek: laeb viimati kontrollitud puu seisu.\n- Klõps tipul: muudab tipu aktiivseks, võimaldab lisada uue alluva ja muuta tipu väärtust. Aktiivse tipu väärtust saab muuta, kasutades backspace-i ning kirjutades asemele uue väärtuse.";
            case "eemaldamine_bst" ->
                "Kasutusjuhend:\n- Kontrolli eemaldust: kontrollib tipu eemaldust ja võtab eemaldatavate järjendist uue eemaldatava.\n- Lae eelmine puu olek: laeb viimati kontrollitud puu seisu.\n- Rohelise tipu kirjet saab muuta, kui ta on ainus aktiivne tipp.\n- Lisa vasak/parem alluv: lisab punase tipu rohelise tipu vasakuks/paremaks alluvaks. Aktiivse tipu väärtust saab muuta, kasutades backspace-i ning kirjutades asemele uue väärtuse.";
            case "lisamine_avl" ->
                "Kasutusjuhend:\n- Kontrolli lisamist: kontrollib tipu lisamise sammu.\n- Lae eelmine puu olek: laeb viimati kontrollitud puu seisu.\n- Eemalda seos alluvaga: eemaldab seose vasaku või parema alluvaga.\n- Lisa vasak/parem alluv: lisab punase tipu rohelise tipu vasakuks või paremaks alluvaks. Aktiivse tipu väärtust saab muuta, kasutades backspace-i ning kirjutades asemele uue väärtuse.";
            case "eemaldamine_avl" ->
                "Kasutusjuhend:\n- Lukusta puu olek: kontrollib tipu eemaldust.\n- Lae eelmine puu olek: laeb viimati lukustatud puu seisu..\n- Eemalda seos alluvaga: eemaldab seose vasaku või parema alluvaga.\n- Lisa vasak/parem alluv: lisab punase tipu rohelise tipu vasakuks või paremaks alluvaks. Aktiivse tipu väärtust saab muuta, kasutades backspace-i ning kirjutades asemele uue väärtuse.";
    ...
    public static String massiiv(String key) {
        return switch (key) {
            case "mullimeetod" ->
                "Mullimeetod\n\nKasuta \"Alusta\" nuppu, et laadida uus ülesanne. Sea vajadusel tööala (elemendid indeksitega algus .. lõpp-1). Kahe elemendi vahetuseks kasuta nuppu \"Vaheta\". Mullimeetodis tehakse vahetusi ainult naaberelementide vahel. \"Tagasi\" võtab viimase sammu tagasi ja \"Lõpeta\" lõpetab läbimängu.";
            case "pistemeetod" ->
                "Pistemeetod\n\nKasuta \"Alusta\" nuppu, et laadida uus ülesanne. Sea vajadusel tööala (elemendid indeksitega algus .. lõpp-1) ning tee sammud indeksitega.\n\"Piste\" paneb 1. indeksil oleva elemendi 2. indeksiga määratud kohale (vahele), \"Tagasi\" võtab viimase sammu tagasi ja \"Lõpeta\" lõpetab läbimängu.";
            case "valikumeetod" ->
    ...
    public static String paisktabel(String key) {
        return switch (key) {
            ...
            case "positsioon" ->
                "Positsioonimeetod\n\nKasuta \"Alusta\" nuppu, et laadida uus ülesanne. Esmalt sisesta paisktabeli algseadistus vastavale väljale. \"Sisesta\" võtab esialgsest massiivist indeksil i oleva elemendi ja paigutab ta paisktabeli rea indeksile r, elemendiks indeksiga k (kui k on tühi, paigutatakse element rea algusesse). Paisktabelist järjendisse lugemine teostatakse nupu \"Eemalda\" abil, määrates millisest reast element loetakse tagasi järjendisse. Nupp \"Võta tagasi\" tühistab viimase sammu ja \"Lõpeta\" lõpetab läbimängu.";
            default -> "";
        };
    }
}
